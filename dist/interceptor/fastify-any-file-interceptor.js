...
exports.FastifyAnyFileInterceptor = void 0;
const common_1 = require("@nestjs/common");
const fastify_multer_1 = require("fastify-multer");
function FastifyAnyFileInterceptor(localOptions) {
    let MixinInterceptor = class MixinInterceptor {
        ...
        intercept(context, next) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield new Promise((resolve, reject) => this.multer.any()(ctx.getRequest(), ctx.getResponse(), (error) => {
                    if (error) {
                        return reject(error);
                    }
                    resolve();
...
exports.FastifyAnyFileInterceptor = FastifyAnyFileInterceptor;
//# sourceMappingURL=fastify-any-file-interceptor.js.map