...
function FastifyFileFieldsInterceptor(fields, localOptions) {
    let MixinInterceptor = class MixinInterceptor {
        ...
        intercept(context, next) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield new Promise((resolve, reject) => this.multer.fields(fields)(ctx.getRequest(), ctx.getResponse(), (error) => {
                    if (error) {
                        return reject(error);
                    }
                    resolve();
...
//# sourceMappingURL=fastify-file-field-interceptor.js.map