...
exports.FilesFastifyInterceptor = void 0;
...
function FilesFastifyInterceptor(fieldName, maxCount, localOptions) {
    let MixinInterceptor = class MixinInterceptor {
        ...
        intercept(context, next) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield new Promise((resolve, reject) => this.multer.array(fieldName, maxCount)(ctx.getRequest(), ctx.getResponse(), (err) => {
                    if (err) {
...
exports.FilesFastifyInterceptor = FilesFastifyInterceptor;
//# sourceMappingURL=files-fastify-interceptor.js.map