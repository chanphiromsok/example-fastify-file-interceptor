...
exports.AnyFilesFastifyInterceptor = void 0;
...
function AnyFilesFastifyInterceptor(localOptions) {
    let MixinInterceptor = class MixinInterceptor {
        ...
        intercept(context, next) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield new Promise((resolve, reject) => this.multer.any()(ctx.getRequest(), ctx.getResponse(), (err) => {
                    if (err) {
...
exports.AnyFilesFastifyInterceptor = AnyFilesFastifyInterceptor;
//# sourceMappingURL=any-file-fastify-interceptor.js.map