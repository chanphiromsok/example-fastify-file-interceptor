...
exports.FileFieldsFastifyInterceptor = void 0;
...
function FileFieldsFastifyInterceptor(fields, localOptions) {
    let MixinInterceptor = class MixinInterceptor {
        ...
        intercept(context, next) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield new Promise((resolve, reject) => this.multer.fields(fields)(ctx.getRequest(), ctx.getResponse(), (err) => {
                    if (err) {
    ...
    MixinInterceptor = tslib_1.__decorate([
        ...
        tslib_1.__param(0, common_1.Inject(multer_module_option_1.MULTER_MODULE_OPTIONS)),
        tslib_1.__metadata("design:paramtypes", [Object])
    ], MixinInterceptor);
    const Interceptor = common_1.mixin(MixinInterceptor);
    return Interceptor;
}
exports.FileFieldsFastifyInterceptor = FileFieldsFastifyInterceptor;
//# sourceMappingURL=file-fields-fastify-interceptor.js.map